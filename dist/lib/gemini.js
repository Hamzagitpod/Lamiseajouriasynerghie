 ...
 */
async function readLaborCodeFromBucket() {
    try {
 ...
 */
export async function askGemini({ apiKey, query, profile, systemPrompt, modelName = "gemini-2.5-pro", }) {
    try {
...
`;
        ...
        if (!text)
            return "Aucune réponse textuelle n'a été générée.";
        return text;
    }
    catch (error) {
